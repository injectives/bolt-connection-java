...
public class CommonValuePacker implements ValuePacker {
    ...
    protected void packInternalValue(Value value) throws IOException {
        switch (value.boltValueType()) {
            ...
            case MAP -> packMap(value);
            case LIST -> packList(value);
            case VECTOR -> packVector(value.asBoltVector());
            case UNSUPPORTED -> packUnsupported();
    ...
    protected void packMap(Value value) throws IOException {
    ...
    protected void packList(Value value) throws IOException {
    ...
    protected void packUnsupported() {
        throw new BoltClientException("Unsupported type must not be sent to the server");
    }
