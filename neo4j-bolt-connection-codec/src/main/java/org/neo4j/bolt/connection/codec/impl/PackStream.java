    ...
    public static class Unpacker {
        ...
        public PackStreamType peekNextType() throws IOException {
            ...
            return switch (markerHighNibble) {
                case TINY_STRING -> PackStreamType.STRING;
                case TINY_LIST -> PackStreamType.LIST;
                case TINY_MAP -> PackStreamType.DICTIONARY;
                case TINY_STRUCT -> PackStreamType.STRUCTURE;
                default ->
                    switch (markerByte) {
                        case NULL -> PackStreamType.NULL;
                        case TRUE, FALSE -> PackStreamType.BOOLEAN;
                        case FLOAT_64 -> PackStreamType.FLOAT;
                        case BYTES_8, BYTES_16, BYTES_32 -> PackStreamType.BYTES;
                        case STRING_8, STRING_16, STRING_32 -> PackStreamType.STRING;
                        case LIST_8, LIST_16, LIST_32 -> PackStreamType.LIST;
                        case MAP_8, MAP_16, MAP_32 -> PackStreamType.DICTIONARY;
                        case STRUCT_8, STRUCT_16 -> PackStreamType.STRUCTURE;
                        case UUID_16 -> PackStreamType.UUID;
                        default -> PackStreamType.INTEGER;
                    };
            };
        }
