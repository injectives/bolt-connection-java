...
public final class ValueDecoderImplV61 extends ValueDecoderImplV6 {

    public ValueDecoderImplV61(ValueFactory valueFactory) {
        super(valueFactory);
    }

    @Override
    protected ValueUnpacker valueUnpacker(ReadInput input) {
        return new ValueUnpackerV61(new ReadInputAdapter(input), valueFactory);
    }
}
