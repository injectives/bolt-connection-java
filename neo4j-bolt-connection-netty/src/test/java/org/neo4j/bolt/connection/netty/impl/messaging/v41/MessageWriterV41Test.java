 ...
 */
package org.neo4j.bolt.connection.netty.impl.messaging.v41;
...
class MessageWriterV41Test extends AbstractMessageWriterTestBase {
    ...
    protected MessageFormat.Writer newWriter() {
        return BoltProtocolV41.INSTANCE.createMessageFormat().newWriter(valueFactory);
    }

    @Override
    protected ValueDecoder newDecoder() {
        return ValueDecoderFactory.create(BoltProtocolV41.VERSION, valueFactory);
    }
