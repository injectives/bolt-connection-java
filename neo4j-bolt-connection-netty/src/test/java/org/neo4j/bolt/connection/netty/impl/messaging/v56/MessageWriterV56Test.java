 ...
 */
package org.neo4j.bolt.connection.netty.impl.messaging.v56;
...
public class MessageWriterV56Test extends AbstractMessageWriterTestBase {
    ...
    protected MessageFormat.Writer newWriter() {
        return BoltProtocolV56.INSTANCE.createMessageFormat().newWriter(valueFactory);
    }

    @Override
    protected ValueDecoder newDecoder() {
        return ValueDecoderFactory.create(BoltProtocolV56.VERSION, valueFactory);
    }
