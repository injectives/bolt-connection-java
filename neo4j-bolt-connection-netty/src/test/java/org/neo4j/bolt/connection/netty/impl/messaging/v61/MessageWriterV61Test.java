...
public class MessageWriterV61Test extends AbstractMessageWriterTestBase {
    @Override
    protected MessageFormat.Writer newWriter() {
        return BoltProtocolV61.INSTANCE.createMessageFormat().newWriter(valueFactory);
    }

    @Override
    protected ValueDecoder newDecoder() {
        return ValueDecoderFactory.create(BoltProtocolV61.VERSION, valueFactory);
    }
